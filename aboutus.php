  ...
  <body>
    <div id="aboutus">
      ...
      <div id="principal">
        <h2>About Us</h2>
        <p>
        iTEC is committed to redefining how people interact with technology. During the years, we have pursued constant innovation and excellence, with the mission of creating technological solutions that simplify daily life.
      </p>
      </div>
      ...
      <div id="our_mission">
        <h3>Our Action</h3>
          <p>
          iTEC, offers range of technological products designed to simplify your life. From cutting-edge electronic devices to smart solutions for home and office, each product is carefully designed to offer intuitive functionality and exceptional performance.
          Our smartphones blend elegant design with advanced technology, providing a smooth and engaging experience. Smart home devices transform your space, providing greater comfort and efficiency. For those moments when your technology needs assistance, we offer support and repair services.
          </p>
      </div>
